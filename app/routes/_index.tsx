  ...
  return (
    <>
      ...
      <FlexContainer justify="center" direction="column">
        ...
        />
        <ParallaxImage
          imageUrl="/fitLife/yogaGradient.png"
        ...
        <div className="mainContent">
          ...
          <FitSection
            ...
            image={"/fitLife/fitImage03.png"}
            imagePosition="right"
            imageAlt="Image"
          />
          <FlexContainer padding="10px">
            Visit FitLife Studio today and take the first step towards a fitter,
            happier you! Our friendly staff is ready to assist you on your
            fitness journey. Let's make this transformation together!
          </FlexContainer>
        </div>
        <div
          style={{
